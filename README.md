...
`src/pydcapi/models` and `src/pydcapi/resources` are generated by [`codegen/`](codegen/README.md)
from Adobe's discovery document and JSON schemas; do not edit them by hand.

```
uv run --group codegen python -m codegen generate
```
