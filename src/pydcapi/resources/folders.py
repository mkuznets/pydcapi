...
class Folders:
    ...
    def list(self, *, include_composite_types: Optional[Literal["horizon"]] = None, order_by: Optional[Literal["name", "size", "type", "extension", "created", "modified", "last_access"]] = None, sort_order: Optional[Literal["ascending", "descending"]] = None, folder_uri: str, metadata: Literal["min", "basic"] = "basic", page_size: int = 5000) -> "folder_listing_v1.Model":
        from ..models import folder_listing_v1

        url = uritemplate.partial(
            uri="{+folder_uri}/contents{?order_by,sort_order,page_size,metadata,include_composite_types}",
            var_dict={
                "include_composite_types": include_composite_types,
                "order_by": order_by,
