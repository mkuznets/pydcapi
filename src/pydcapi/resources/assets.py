...
import re
from typing import IO, TYPE_CHECKING, Any, Dict, Literal, Optional, Union
...
if TYPE_CHECKING:
    from ..models import (
        ...
        createexpress_from_html_parameters_v1,
        createpdf_from_html_parameters_v1,
        createpdf_parameters_v1,
        createppt_from_html_parameters_v1,
        exportnotedoc_parameters_v1,
        exportpdf_parameters_v1,
        new_asset_job_v1,
        pdf_actions_parameters_v1,
        redactpdf_parameters_v1,
...
class Assets:
    ...
    def createexpress_from_html(self, *, _data: "createexpress_from_html_parameters_v1.Model") -> "new_asset_job_v1.Model":
        from ..models import new_asset_job_v1

        url = "https://dc-api-v2.adobe.io/{expiry}/assets?operation=createexpress_from_html"
        headers: Dict[str, str] = {}
    ...
    def createppt_from_html(self, *, _data: "createppt_from_html_parameters_v1.Model") -> "new_asset_job_v1.Model":
        from ..models import new_asset_job_v1

        url = "https://dc-api-v2.adobe.io/{expiry}/assets?operation=createppt_from_html"
        headers: Dict[str, str] = {}
        headers["Accept"] = 'application/vnd.adobe.dc+json; profile="https://dc-api.adobe.io/schemas/new_asset_job_v1.json"'
    ...
    def document_rendition(self, *, format_: Optional[Literal["ftpdf", "jcos", "owp"]] = None, asset_rendition_uri: str, fallback: Literal["original", "none"] = "original") -> Union[Any, bytes, str]:
        url = uritemplate.partial(
    ...
    def exportnotedoc(self, *, _data: "exportnotedoc_parameters_v1.Model") -> "new_asset_job_v1.Model":
        from ..models import new_asset_job_v1

        url = "https://dc-api-v2.adobe.io/{expiry}/assets?operation=exportnotedoc"
        headers: Dict[str, str] = {}
        headers["Accept"] = 'application/vnd.adobe.dc+json; profile="https://dc-api.adobe.io/schemas/new_asset_job_v1.json"'
    ...
    def redactpdf(self, *, _data: "redactpdf_parameters_v1.Model") -> "new_asset_job_v1.Model":
        from ..models import new_asset_job_v1

        url = "https://dc-api-v2.adobe.io/{expiry}/assets?operation=redactpdf"
        headers: Dict[str, str] = {}
        headers["Accept"] = 'application/vnd.adobe.dc+json; profile="https://dc-api.adobe.io/schemas/new_asset_job_v1.json"'
    ...
    def rendition(self, *, download: bool, format_: Optional[Literal["png", "jpg"]] = None, page: int, rendition_class: Optional[str] = None, size: Optional[str] = None, asset_rendition_uri: str, markup: bool = True, processing_hint: Literal["speed_over_quality", "quality_over_speed"] = "speed_over_quality", wait: int = 10) -> bytes:
        url = uritemplate.partial(
    ...
    def rendition_direct(self, *, asset_id: str, download: bool, format_: Optional[Literal["png", "jpg"]] = None, page: int, rendition_class: Optional[str] = None, size: Optional[str] = None, markup: bool = True, processing_hint: Literal["speed_over_quality", "quality_over_speed"] = "speed_over_quality", wait: int = 10) -> bytes:
        url = uritemplate.partial(
    ...
    def tag(self, *, _pdf: bytes, async_: bool, client_version: Optional[str] = None, qualify: bool, format_: Literal["instance_data", "fully_tagged_pdf"] = "instance_data") -> bytes:
        url = uritemplate.partial(
    ...
    def update(self, *, _file: Union[IO[bytes], bytes, str], asset_uri: Optional[str] = None) -> None:
        url = uritemplate.partial(
