...
class Users:
    ...
    def get_upsell(self, *, entitlement: Optional[Literal["can_send_to_individuals", "can_send_av", "create_pdf_conversions", "combine_pdf_conversions", "export_pdf_conversions", "export_pdf2ppt_conversions", "export_pdf2img_conversions", "acrobat_pro"]] = None, user_uri: str = "https://dc-api-v2.adobe.io/{expiry}/users/self") -> "user_upsell_v1.Model":
    ...
    def get_user(self, *, fields: Optional[str] = None, user_uri: str = "https://dc-api-v2.adobe.io/{expiry}/users/self") -> "user_v1.Model":
